...
def _run_seed_data() -> None:
    ...
    INSERT INTO port_configs (key, value, description) VALUES
        ...
        ('track_min_confirm_sec',          '1.5',        'Seconds before TENTATIVE becomes CONFIRMED (overrides track_min_hits when set)'),
        ...
        ('ocr_interval_sec',               '0.5',        'Seconds between OCR attempts (overrides ocr_interval_frames when set)'),
